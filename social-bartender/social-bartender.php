...
define( 'SH_SB_DIR', get_template_directory_uri() . '/social-bartender/' );
	...
	foreach( $items as $item ):
		...
		if( $link ):
			...
			if( $icon && get_option( 'sh_sb_title_only' ) != 'yes' ){
				$output .= '<img src="'.$icon.'" alt="'.$title.'" class="matrix_social_footer" />';
			}
...
require_once(TEMPLATEPATH . "/social-bartender/settings.php");
require_once(TEMPLATEPATH . "/social-bartender/help.php");
require_once(TEMPLATEPATH . "/social-bartender/widget.php");
